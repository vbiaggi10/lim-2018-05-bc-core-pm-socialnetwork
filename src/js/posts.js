...
const setFile = document.querySelector('#set-file');
setFile.value = '';
let count_click = 0;
let fileName = '';
let fileUrl = '';
...
const paintPost = (postKey, userId) => {
  postKey.forEach(keys => {
    let postId = keys.key;
    if (window.location.pathname === '/lim-2018-05-bc-core-pm-socialnetwork/src/wall.html' || window.location.pathname === '/src/wall.html') {
